	...
	do
	{
		...
		if ( !hasWindowsSentAMessage )
		{
			...
			offset.x =offset.z = offset.y = 0.0f;
			{
				...
				if (eae6320::UserInput::IsKeyPressed('T'))
					toggleflycam = true;
				...
				{
					if(toggleflycam)
						Camera::getInstance().camera_axis.z -= 1.0f;
			...
			if(!(eae6320::UserInput::IsKeyPressed(VK_LEFT) || eae6320::UserInput::IsKeyPressed(VK_RIGHT) || eae6320::UserInput::IsKeyPressed(VK_UP) || eae6320::UserInput::IsKeyPressed(VK_DOWN) || toggleflycam))
